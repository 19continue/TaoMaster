...
public sealed class AppLocalizer
{
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishStrings =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["remoteJdkProviderHint"] = "Remote JDK downloads currently use Temurin. Oracle JDK already supports local discovery and import into TaoMaster.",
            ...
            ["validationSelectRemoteJdkVersion"] = "Select a Temurin JDK version first.",
    ...
    private static readonly IReadOnlyDictionary<string, string> SimplifiedChineseStrings =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["remoteJdkProviderHint"] = "远程 JDK 下载当前只接入 Temurin。Oracle JDK 已支持本机发现和导入到 TaoMaster 管理。",
            ["temurinJdkLabel"] = "Temurin JDK",
            ["apacheMavenLabel"] = "Apache Maven",
            ["installButton"] = "安装",
            ...
            ["validationSelectRemoteJdkVersion"] = "请先选择一个 Temurin JDK 版本。",
